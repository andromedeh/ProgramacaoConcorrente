...
public class MainController implements Initializable{
  ...
  private String trilha = "resources/opening.mp3";
  private Media media = new Media(new File(trilha).toURI().toString());
  ...
  ******************************************************************* */
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    mediaPlayer.setOnEndOfMedia(() -> {
      mediaPlayer.seek(mediaPlayer.getStartTime());// reinicializa a musica quando chega ao final
      mediaPlayer.play();// da play novamente
    });
  ...
  ******************************************************************* */
  ...
  /*********************************************************************
  * Metodo: music
  * Funcao: controla o volume da musica da animacao e troca o icon do btnMusic
  ...
  ******************************************************************* */
  ...
  void music(ActionEvent event) {
    Image icon;
    if (isPlaying){ // se estiver tocando e quiser mutar
      mediaPlayer.setVolume(0);
      icon = new Image("resources/img/musicOff.png");
      isPlaying = false; // mutado
